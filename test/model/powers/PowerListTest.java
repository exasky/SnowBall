...
public class PowerListTest {
	public static void main(String[] args){
		...
		System.out.println(powerList2.getCurrentPower() + "; " + powerList2.currentPowerIndex + "; "
				+ powerList2.powerCounts.toString());
		
		for (int i = 0; i < 3; i++) {
			Power popCurrentPower = powerList2.popCurrentPower();
			System.out.println(popCurrentPower + "; " + powerList2.currentPowerIndex + "; " + powerList2.powerCounts.toString());
		}
